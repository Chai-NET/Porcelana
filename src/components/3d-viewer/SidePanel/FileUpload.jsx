...
const FileUpload = ({ onFileUpload }) => (
  <div className="group mb-6 transition-all duration-500 ease-in-out">
    <label className="shadow-dark25/0 flex h-35 w-full cursor-pointer items-center justify-center rounded-2xl border-[0.14rem] border-dashed border-zinc-600 shadow-lg transition-all duration-500 ease-in-out group-hover:border-zinc-100 group-hover:shadow-white/30 2xl:h-45">
