...
const ScreenAlert = ({ isSmallScreen }) => {
  ...
  return (
    <div
      className={`absolute left-1/2 z-50 -translate-x-1/2 transition-all delay-150 duration-700 ease-linear ${isSmallScreen ? "top-6" : "-top-24"} `}
    >
      {/* Alert */}
      <div
        className={`bg-dark25/45 overflow-clip rounded-lg border border-yellow-500/35 px-4 py-3 backdrop-blur-2xl`}
      >
